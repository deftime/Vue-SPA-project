<template>
  <div class="free mainQu">
    <div class="descQu">
      ...
      <p>Запитання у загальному режимі обробляються у порядку черги, а час очікування відповіді залежить від завантаження сервісу. Щоб гарантовано отримати розширену відповідь у найближчий час - скористайтесь <router-link to="/paid" tag="a" style="color: #ff7207; text-decoration: none;">Питанням PRO.</router-link></p>
