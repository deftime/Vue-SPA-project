<template>
  <div class="paid mainQu">
    <div class="descQu">
      ...
      <p><strong>Вартість відповіді складає 500 грн.</strong></p>
      ...
      <p>Ви <strong>можете продовжити спілкуватись з юристом</strong> по темі питання після отримання відповіді, якщо вам необхідні будуть додаткові уточнення чи роз'яснення.</p>
    </div>
    <div class="formQu">
